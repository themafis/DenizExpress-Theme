    ...
    <section style="padding: 80px 0; background: var(--bg-main);">
        <div class="container">
            ...
            <div class="blog-grid">
                ...
                <article class="blog-card glass-card gs-reveal-up">
            ...
            <div style="text-align: center; padding: 80px 0;">
                <i class="fa-solid fa-newspaper" style="font-size: 60px; color: var(--primary-color); margin-bottom: 20px; display: block;"></i>
                <h2 style="color: #fff;">Henüz blog yazısı eklenmemiş.</h2>
                <p style="color: var(--text-muted);">WordPress panelinden "Yazılar > Yeni Ekle" ile blog yazılarınızı ekleyebilirsiniz.</p>
            </div>
            <?php endif; ?>
        </div>
    </section>
